...
function UpdateProfile() {
  ...
  useEffect(() => {
    ...
    if (user) {
      ...
      setName(user.name);
      setEmail(user.email);
      setAvatarPreview("https://imgs.search.brave.com/etj6rgfEte059Nki-E94-3n0NNkpXdhOomIeiA-NNr4/rs:fit:860:0:0/g:ce/aHR0cHM6Ly90NC5m/dGNkbi5uZXQvanBn/LzA2Lzc2LzQwLzA1/LzM2MF9GXzY3NjQw/MDU4NF9HakpnOGk0/TTVFejdrSlBXRHRL/UG83RDJYaFRPNWhV/ci5qcGc");
    }
