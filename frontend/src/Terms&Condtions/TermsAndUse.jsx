    ...
    <div className="privacy-policy-container">
      ...
      <div className="container___">
        ...
        <p>
          ...
          Evo-Greenmay, for any reason, refuse to accept or may cancel or
        ...
        <p>
          ...
          Evo-Greenreserves the right to amend pricing for any pricing
          ...
          submitted an online order, Evo-Greenwill notify you of the error
        ...
        <p>
          ...
          Evo-Greenreserves the right to change or discontinue such offers
          at any time.
        </p>
        <h2>Taxes</h2>
        <p>
          The prices quoted for the products sold hereunder include applicable
          taxes. Customer shall pay, and reimburse Evo-Greenif it pays, any
        ...
        <p>
          ...
          process. Any timeframe provided by Evo-Greenfor when the
          ...
          are beyond our control. Evo-Greencannot be held liable for late
        ...
        <p>
          ...
          expenses. The product(s) must be returned to Evo-Greenwithin
        ...
        <p>
          ...
          indemnify and hold Evo-Greenharmless from and against any and all
