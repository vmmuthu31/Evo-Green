      ...
      <div className={classes.about_us}>
        ...
        <Container className={classes.container_12}>
          <Grid container spacing={4} justifyContent="center">
            <Grid item xs={12} sm={6}>
              <img
                src="https://imgs.search.brave.com/Frd1ZyiSuWFwoIfqhZhPWXufT1h2tASL9dvq3uFVezs/rs:fit:860:0:0/g:ce/aHR0cHM6Ly9lY29t/YW5pYWMub3JnL3dw/LWNvbnRlbnQvdXBs/b2Fkcy8yMDIyLzEx/L1RoZS1HcmVlbi1F/bnZpcm9ubWVudC5q/cGc"
                alt="CricketWeapon"
            ...
            <Grid item xs={12} sm={6}>
              ...
              <Typography variant="body1" className={classes.introText_about}>
                Evo-Greenstore is an online cricket sports selling startup
                started in 2019. We have served more than 20,000 customers
                through social media and other platforms. We are proud to offer
                our own products under the brand name CW, also known as Evo-Green.
              </Typography>
              <Typography variant="body1" className={classes.introText_about}>
                Evo-Greenwas founded by Lokesh Samant, a talented cricket
        ...
        <Container className={classes.container_12}>
          ...
          <Typography variant="body1" className={classes.infoText_about}>
            Evo-Greenis dedicated to providing high-quality cricket
        ...
        <Container className={classes.container_12}>
          ...
          <Typography variant="body1" className={classes.infoText_about}>
            Evo-Greenis driven by the mission to provide high-quality
