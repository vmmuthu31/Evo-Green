    ...
    <div className="terms-container">
      ...
      <div className="terms-content">
        ...
        <p>
          ...
          from those in physical stores that stock Evo-Greenproducts. We
        ...
        <p>
          ...
          Evo-Greenis required to collect and pay taxes on Customer's
        ...
        <p>
          You agree to indemnify and hold Evo-Greenharmless from any
          claims, costs, proceedings, losses, or demands arising from your
          breach of these Terms or anyone using your account.
        </p>
        <h2>Entire Agreement</h2>
        <p>
          These Terms constitute the entire agreement between Evo-Greenand
